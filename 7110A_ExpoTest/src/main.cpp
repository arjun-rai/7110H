...
void leftExpo2 (vex::directionType type, int percentage){
  if(percentage >= 0){
    percentage = 0.9*pow(1.04833, percentage) + 0*percentage - 0.9;
  }else{
    percentage = -percentage;
    percentage = 0.9*pow(1.04833, percentage) + 0*percentage - 0.9;
    percentage = -percentage;
...
void rightExpo2 (vex::directionType type, int percentage){
  if(percentage >= 0){
    percentage = 0.9*pow(1.04833, percentage) + 0*percentage - 0.9;
  }else{
    percentage = -percentage;
...
/*---------------------------------------------------------------------------*/
int expo = 1;
bool expoToggle = false;
int scuffedTurnVar = 1;
int scuffedTurnVar2 = 1;
bool intakeOn = false;
...
void usercontrol(void) {
  ...
  while (1) {
    ...
    if(expo == 2){
      leftExpo2(vex::directionType::fwd, (Controller.Axis3.value() + Controller.Axis1.value()));
      rightExpo2(vex::directionType::fwd, (Controller.Axis3.value() - Controller.Axis1.value()));
    }
    if(expo == 3){
      if(abs(Controller.Axis4.value()) < 10){
        leftExpo(vex::directionType::fwd, (Controller.Axis3.value() + Controller.Axis1.value()));
        rightExpo(vex::directionType::fwd, (Controller.Axis3.value() - Controller.Axis1.value()));
      }else{
        leftExpo2(vex::directionType::fwd, (Controller.Axis4.value()));
        rightExpo2(vex::directionType::fwd, (-Controller.Axis4.value()));
      }
    }
    if(expo == 4){
      if(abs(Controller.Axis3.value()) > 10)
        ...
        scuffedTurnVar = 1;
      if(abs(Controller.Axis1.value()) > 10)
        scuffedTurnVar2 = 0;
      else
        scuffedTurnVar2 = 1;
      leftExpo(vex::directionType::fwd, (Controller.Axis3.value()*scuffedTurnVar2 + Controller.Axis1.value()*scuffedTurnVar));
      rightExpo(vex::directionType::fwd, (Controller.Axis3.value()*scuffedTurnVar2 - Controller.Axis1.value()*scuffedTurnVar));
    }
