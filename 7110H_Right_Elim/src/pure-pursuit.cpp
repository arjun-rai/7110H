...
double max_accel = 130; //in/s^3  used to be 6 150
...
bool pathing(std::vector<pathPoint> path, bool backwards, bool stop, double look, double tValue)
{
  l = look;
  timer t = timer();
  double lastVel = 0;
