...
void autonomous(void) {
  ...
  desiredValue=-280;
  wait(1000, msec);
  intake.spinFor(fwd, 540, deg, 100, vex::velocityUnits::pct);
  // load=true;
  wait(1000, msec);
  desiredValue=50;
  wait(500, msec);
